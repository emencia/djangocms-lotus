...
import djangocms_lotus
from djangocms_lotus.factories.cms import PageFactory
...
class FixturesSettingsTestMixin(object):
    ...
    def __init__(self):
        self.application_path = Path(
            djangocms_lotus.__file__
        ).parents[0].resolve()
        self.application_urlpath = "djangocms_lotus"
    ...
    def format(self, content):
        ...
        return content.format(
            ...
            VERSION=djangocms_lotus.__version__,
        )
